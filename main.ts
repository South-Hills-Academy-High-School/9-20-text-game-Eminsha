...
game.showLongText("You have 2$ and Arizona Iced Tea", DialogLayout.Bottom)
if (game.ask("Drink the Tea", "walk 10 miles")) {
    GameOver("You got more thristy and died")
} else {
    scene.setBackgroundImage(img`
        
        ...
        
    ...
    mySprite = sprites.create(img`
        ...
        ...............................................................ccccc..ccc....
        `, SpriteKind.Player)
    game.showLongText("after walking some time tou reach a road and meet an dinosore who is breakdancing", DialogLayout.Bottom)
    game.showLongText("The dinosore says: give me something", DialogLayout.Bottom)
    if (game.ask("give 2$", "give iced tea")) {
        GameOver("dinosore eats you")
    } else {
...
scene.setBackgroundImage(img`
    ...
    7777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777777
    `)
game.showLongText("after some time of walking you reach the city", DialogLayout.Bottom)
game.showLongText("what you should do next?", DialogLayout.Bottom)
if (game.ask("eat trash", "look for food stands")) {
    GameOver("trash got stuck in your throatand you died")
} else {
    game.showLongText("you start to look for stands", DialogLayout.Bottom)
}
